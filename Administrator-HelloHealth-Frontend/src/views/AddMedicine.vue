...
<!--                    <button @click="gotoManageMedicinePage">返回</button>-->
                    ...
                    <el-row>
                        <div class="annotation">请填写药品信息</div>
                    </el-row>
                    <br>
                    <el-row>
                ...
                <el-col :span="6">
                    <img class="illustration" src="@/assets/15.png">
                </el-col>
            </el-row>
        </el-card>
    </div>
            ...
            <el-row class="info-input">
                ...
                <el-col :span="18">
                    <div class="input-container">
                        <input type="text" name="text" class="input" placeholder="请输入药品中文名称">
...
<!--    methods: {-->
<!--        gotoAddMedicinePage() {-->
<!--            this.$router.replace('/medicineManagement');-->
<!--        }-->
<!--    }-->
<!--}-->
<!--</script>-->
